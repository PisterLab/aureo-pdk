...
my $script_dir = '/home/aa/users/cs199-cwg/aureoProject/aureo-pdk/debugTech/testConformal2/.tech_scripts';
`perl $script_dir/mw_limits.pl 0 $model_dir $profile_dir $version -exe $qts_dir`;
